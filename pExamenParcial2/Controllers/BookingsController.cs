...
namespace HotelAGC.Controllers
{
    public class BookingsController : Controller
    {
        ...
        {
            var _bookings = _context.Bookings.Include(b => b.Customer);
            var bookings = from p in _bookings select p;

            if(!string.IsNullOrEmpty(searchString)){
                bookings = bookings.Where(p => p.Customer.CustomerForenames.Contains(searchString));
            }
